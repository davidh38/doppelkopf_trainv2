...
*** gamedict
   - rounds_total: int             # Total number of rounds to be played in this game
   ...
   - round_data: Dict[int, rounddata] # Data for each round, keyed by round number
   - scores: Dict                  # Overall scores for the game

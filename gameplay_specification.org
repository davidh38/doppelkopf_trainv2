...
** Game Flow
   1. [[./table_creation_specification.org][Create game]]
      - Shuffle the cards
      - Distribute the cards to players
   2. [[./player_connection_specification.org][Player Connection]]
   3. Determine first player to act
   ...
   8. Compute round win
   9. Compute game summary and final scores
